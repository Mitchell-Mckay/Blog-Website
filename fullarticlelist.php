...
$query2 = "SELECT posts.post_id, posts.author_id, posts.title, posts.content, posts.postCreated, posts.postUpdated, posts.publish_stat, users.fname, users.sname 
FROM `posts` JOIN users ON posts.author_id = users.user_id ORDER BY posts.post_id ASC;";
            ...
            <div class="row">
               <div data-aos="fade-up">
                  <div class="text-center">
                     <h1 class="page-title">View All Posts</h1>
                  </div>
                  <form method="GET" action="singlearticle.php">

                     <table id="articles" width=100% cellpadding="5px">
                        ...
                        <tbody>
                           ...
                           while ($row2 = mysqli_fetch_array($result2)) {
                              $publish_stat = $row2['publish_stat'];
                           ...
                           ?>
                                 <tr>
                                    ...
                                    <td style="width:30%"> <?php echo $row2['title']; ?> </td>
                                    <td style="width:10%"> <?php echo $row2['fname'] . "<br>" . $row2['sname']; ?> </td>
                                    <td> <?php echo substr($row2['content'], 0, 76) . substr($row2['content'], 76, 80) . "..."; ?> </td>
                                    <td style="width:9%"> <?php echo substr($row2['postCreated'], 0, 10); ?> </td>
                                    <td style="width:7%"> <?php echo substr($row2['postUpdated'], 0, 10); ?> </td>
                                 </tr>
                           <?php
                              } else {
                              }
                     ...
                     <div class=" col-12">
                        <input type="submit" name="category" class="btn btn-primary" value="SHOW ARTICLE!" />
                     </div>
                  </form>
               </div>
            </div>
