...
$query2 = "SELECT comments.content FROM `comments` WHERE `comments`.`comment_id` = '$comment_id'";

$result2 = mysqli_query($conn, $query2) or die("Bad query");

while ($row = mysqli_fetch_array($result2)) {
    $previousdescription = $row['content'];
}
...
if (isset($_POST['update'])) {
    ...
    if (empty($set_clause)) {
        ...
        $query3 = "UPDATE `comments` SET $set_clause WHERE `comments`.`comment_id` = '$comment_id'";
                    ...
                    <div class="row justify-content-center mt-3">
                        <div class="col-lg-12">
                            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                <h2 class="comment-title">Update Comment</h2>
                                <div class="row">
                                    <?php if ($msg != '') { ?>
                                    ...
                                    <div class="col-12 mb-3">
                                        <p>
                                            <textarea class="form-control" name="comment" id="comment" cols="30" rows="10"> <?php echo $previousdescription; ?> </textarea>
                                            <script>
