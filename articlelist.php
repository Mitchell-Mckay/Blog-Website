...
FROM `posts` JOIN users ON posts.author_id = users.user_id WHERE `posts`.`category_id` = '$id'";

$result2 = mysqli_query($conn, $query2) or die("Bad query");

//query 3

$query3 = "SELECT category.category
FROM `category`
                  ...
                  <form method="GET" action="singlearticle.php">
                     ...
                     <table id="articles" width=100% cellpadding="5px">
                        ...
                        <tbody>
                           ...
                           ?>
                                 <tr>
                                    <td> <?php echo $postidbutton; ?> </td>
                                    <td style="width:30%"> <?php echo $row2['title']; ?> </td>
                                    <td style="width:10%""> <?php echo $row2['fname'] . "<br>" . $row2['sname']; ?> </td>
                                    <td> <?php echo substr($row2['content'], 0, 76) . "<br>" . substr($row2['content'], 76, 80) . "..."; ?> </td>
                                    <td> <?php echo substr($row2['postCreated'], 0, 10); ?> </td>
                                    <td> <?php echo substr($row2['postUpdated'], 0, 10); ?> </td>
                                 </tr>
                           <?php
                              } else {
                              }
